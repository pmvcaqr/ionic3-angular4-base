...
@Component({selector: 'qr-component', templateUrl: 'qr-component.html'})

export class QRComponent {
  @Output()scanData : EventEmitter < string > = new EventEmitter < string > ();
